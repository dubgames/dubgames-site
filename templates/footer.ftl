    ...
    <footer>
      <div class="container">
        ...
        <div class="row">
          <div class="col-xs-10">
            <p class="text-muted credit">&copy; ${config.site_copyright} 2014 | Mixed with <a href="http://getbootstrap.com/">Bootstrap v3.1.1</a> | Baked with <a href="http://jbake.org">JBake ${version}</a></p>
          </div>
        </div>
      </div>
    </footer>
    ...
    <script src="http://cdnjs.cloudflare.com/ajax/libs/gist-embed/1.6/gist-embed.min.js"></script>
    </#if>
